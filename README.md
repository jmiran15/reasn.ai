...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create reasn-ai-8294
  fly apps create reasn-ai-8294-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app reasn-ai-8294
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app reasn-ai-8294-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'reasn-ai-8294-staging' does not match app name in config file 'reasn-ai-8294'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name reasn-ai-8294-db
  fly postgres attach --app reasn-ai-8294 reasn-ai-8294-db

  fly postgres create --name reasn-ai-8294-staging-db
  fly postgres attach --app reasn-ai-8294-staging reasn-ai-8294-staging-db
  ```
